...
List<BarChartGroupData> barChartGroupData = [
  ...
  BarChartGroupData(x: 2, barRods: [
    BarChartRodData(toY: 88, color: const Color.fromRGBO(74, 213, 205, 1)),
  ]),
  BarChartGroupData(x: 3, barRods: [
    BarChartRodData(toY: 104, color: const Color.fromRGBO(74, 213, 205, 1)),
  ]),
  BarChartGroupData(x: 4, barRods: [
    BarChartRodData(toY: 115, color: const Color.fromRGBO(74, 213, 205, 1)),
  ]),
  BarChartGroupData(x: 5, barRods: [
    BarChartRodData(toY: 120, color: const Color.fromRGBO(74, 213, 205, 1)),
  ]),
  BarChartGroupData(x: 6, barRods: [
    BarChartRodData(toY: 102, color: const Color.fromRGBO(74, 213, 205, 1)),
  ]),
  BarChartGroupData(x: 7, barRods: [
    BarChartRodData(toY: 91, color: const Color.fromRGBO(74, 213, 205, 1)),
  ]),
  BarChartGroupData(x: 8, barRods: [
    BarChartRodData(toY: 100, color: const Color.fromRGBO(74, 213, 205, 1)),
  ]),
  ...
  BarChartGroupData(x: 30, barRods: [
    BarChartRodData(toY: 81, color: const Color.fromRGBO(74, 213, 205, 1)),
  ])
];
