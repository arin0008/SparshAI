...
class OnboardingItem {
  ...
  final String title;
  OnboardingItem(
      {required this.illustration, required this.title, required this.text});
}
...
class OnboardingItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      color: const Color.fromRGBO(74, 213, 205, 0.3),
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          const SizedBox(height: 40),
          SvgPicture.asset(item.illustration,
          ...
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                shape: (_OnboardingState.currentPage != 2)
                    ? BoxShape.circle
                    : BoxShape.rectangle,
                color: const Color.fromRGBO(74, 213, 205, 1),
              ),
              child: Center(
                child: (_OnboardingState.currentPage == 2)
                    ? const Text(
                        "Get Started",
