...
import 'package:SparshAI/Screens/CameraScan.dart';
import 'package:SparshAI/Screens/LogIn.dart';
import 'package:SparshAI/Services/Database.dart';
import 'package:SparshAI/Services/auth.dart';
import 'package:SparshAI/Services/shared_preference.dart';
import 'package:SparshAI/Widgets/Drawer.dart';
                    ...
                    child: Container(
                      ...
                      decoration: const BoxDecoration(
                          image: DecorationImage(
                              image: AssetImage(
                                  "assets/images/solar_round-graph-outline.jpg"),
                              fit: BoxFit.cover)),
                    ),
                  )
                ],
                      ...
                      child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return SizedBox(
                              ...
                              child: FeatureCard(
                                  text: FeatureData().feature[index]['text'],
                                  icon: FeatureData().feature[index]['icon'],
                                  size: size),
                            );
                          }),
                    ),
