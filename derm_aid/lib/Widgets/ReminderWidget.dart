...
import 'package:SparshAI/Screens/Reminders.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color:
                (done) ? Colors.green : const Color.fromRGBO(220, 220, 220, 1),
            width: 2),
        boxShadow: const [
          BoxShadow(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                Text(
                  data['name'] +
                      (data.containsKey('power') ? (" " + data['power']) : ""),
              ...
              children: [
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (visible == 0)
                          ? const Color.fromRGBO(42, 207, 198, 1)
                          : Colors.white,
                      borderRadius: const BorderRadius.all(Radius.circular(10)),
                      border: Border.all(
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: [
                        SvgPicture.asset('assets/images/Ointment.svg',
                            height: 35,
                            width: 35,
                            color: (visible == 1)
                                ? Colors.white
